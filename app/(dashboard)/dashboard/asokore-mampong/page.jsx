...
export default function RoyalCourtEstate() {
  ...
  const fetchPlotData = async () => {
    try {
      ...
      let { data, error } = await supabase.from("asokore_mampong").select(
        `
      id, 
      properties->>Plot_No,
  ...
  return (
    <div className="">
      <div className="-mt-5 flex items-center justify-between">
        <h1 className="text-primary font-bold text-2xl">Royal Court Estate Plot</h1>
        <Link
