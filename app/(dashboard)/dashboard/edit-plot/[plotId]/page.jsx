...
const EditPlot = () => {
  ...
  const { plotId, dbName } = useParams();
  const router = useRouter();

  console.log('plotId', plotId, 'dbName', dbName);
  // Errors Checks
            ...
            {step1 && (
              <div className="px-6 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="">
                    <h2 className="text-gray-900 font-semibold">Plot Status</h2>
                    <Input
                      type="text"
                      disabled
                      name="plotStatus"
                  ...
                  <div className="">
                    ...
                    {statusEr && (
                      <small className="text-red-900">Choose Plot Status</small>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2 flex-col">
                    ...
                    />
                    {plotTotalAmountEr && (
                      <small className="text-red-900">Enter Plot amount</small>
                    )}
                  </div>

                  <div className="flex gap-2 flex-col">
                    <h2 className="text-gray-900 font-semibold">Paid Amount</h2>
                    <Input
                    ...
                    />
                    {paidAmtEr && (
                      <small className="text-red-900">Enter amount paid</small>
                    )}
                  </div>
