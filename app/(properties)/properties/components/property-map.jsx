...
export default function PropertyMap({ property }) {
  ...
  const { isLoaded } = useJsApiLoader({
    ...
    googleMapsApiKey: process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY || process.env.NEXT_PUBLIC_GOOGLE_API_KEY || "",
  });
  ...
  const coordinates = {
    lat:
      property?.location_coordinates?.coordinates[0] || defaultCoordinates.lat,
    lng:
      property?.location_coordinates?.coordinates[1] || defaultCoordinates.lng,
  };
