    ...
    try {
      ...
      const updateData = {
        ...
        location_coordinates: formData.coordinates
          ? `POINT(${formData.coordinates.lat} ${formData.coordinates.lng})`
          : null,
      };
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-6">
          {formData.images.map((image, index) => (
            <div
              key={index}
              className="overflow-hidden rounded-lg h-32 bg-gray-100"
            >
              <img
                src={image.url}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <p>
              ₵{formData.price} {formData.negotiable ? "(Negotiable)" : ""}
            </p>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-md mt-6">
          ...
          <p className="text-sm mt-1">
            Your property will need to be approved again by an administrator
            after editing.
          </p>
        </div>
      </div>
