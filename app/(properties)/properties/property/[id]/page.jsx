                ...
                <div>
                  ...
                  {property.listing_type === "rent" &&
                    property.rental_duration && (
                      <p className="text-sm text-muted-foreground">
                        Duration: {property.rental_duration.replace("_", " ")}
                      </p>
                    )}
                </div>
...
function StatusDetail({ status }) {
  const statusInfo = {
    ...
    pending: {
      ...
      description:
        "Your property is being reviewed. This usually takes 1-2 business days.",
    },
    rejected: {
      icon: <AlertTriangle className="h-5 w-5 text-red-500" />,
      title: "Rejected",
      description:
        "Your property was rejected. Please review admin feedback and resubmit.",
    },
    sold: {
