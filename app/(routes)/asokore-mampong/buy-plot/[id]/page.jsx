...
const BuyPlot = () => {
  ...
  const databaseName = "asokore_mampong";
  ...
  const fechPlotData = async () => {
    ...
    if (data) {
      ...
      router.replace("/asokore-mampong");
    }
    if (error) {
      console.log(error);
      toast("Something went wrong fetching plot data");
  ...
  const componentProps = {
    ...
    onSuccess: (response) => {
      if (response.status === "success") {
        ...
        router.push("/asokore-mampong/payment/success");
      ...
      fetch(url, {
        ...
        .then((data) => {
          if (
            ...
            router.push("/asokore-mampong/payment/error");
          }
        })
        .catch((error) => {
          console.error(
