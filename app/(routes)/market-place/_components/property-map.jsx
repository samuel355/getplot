...
const PropertyMap = ({ properties, loading }) => {
  ...
  return (
    <div ref={mapContainerRef} className="flex flex-col h-[600px] bg-white rounded-lg shadow-md overflow-hidden relative">
      ...
      <div className="flex items-center justify-between p-2 bg-white border-b z-10">
        ...
        <div className="flex items-center ml-2 space-x-2">
            ...
            {isFilterMenuOpen && (
              <div className="absolute right-0 mt-1 w-64 bg-white rounded-md shadow-lg border z-50">
                <div className="p-3 border-b">
                  <h3 className="font-medium text-gray-700">Filter Properties</h3>
                </div>
                <div className="p-3">
          ...
          <button 
            ...
            title={showPropertyList ? "Hide property list" : "Show property list"}
          >
                  ...
                  {filteredProperties.map(property => (
                    <div 
                      ...
                      className={`p-3 hover:bg-gray-50 cursor-pointer transition-colors ${
                        selectedProperty?.id === property.id ? 'bg-blue-50 border-l-4 border-primary' : ''
                      }`}
            ...
            {filteredProperties.map((property) => (
              property.coordinates && (
                <Marker
                  ...
                  zIndex={selectedProperty && selectedProperty.id === property.id ? 1000 : 1}
                />
              )
            ))}
