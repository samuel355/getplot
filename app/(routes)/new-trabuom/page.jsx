...
import TrabuomMap from "../trabuom/_components/TrabuomMap";
import ChangePriceDialog from "../trabuom/_components/ChangePriceDialog";
import ChangeStatusDialog from "../trabuom/_components/ChangeStatusDialog";
...
const Map = () => {
  ...
  const [launchAtMs, setLaunchAtMs] = useState(null);
        ...
        <div className="w-full max-w-3xl mx-auto mb-6 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-gray-600 text-center">
              We’re finishing the last part (database). For now, this page is in
              preview mode.
            </p>
          </div>

          <div className="mt-5 rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 via-white to-primary/5 px-4 py-5 shadow-md shadow-primary/10">
            {(() => {
              const msLeft = launchAtMs ? launchAtMs - nowMs : 72 * 60 * 60 * 1000;
              ...
              return (
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div className="flex flex-col items-center rounded-xl border border-primary/20 bg-white/80 backdrop-blur px-4 py-3 text-primary shadow-sm">
                      <span className="font-mono text-2xl font-bold leading-none">{pad2(days)}</span>
                      <span className="mt-1 text-[11px] uppercase tracking-wide text-primary/70">Days</span>
                    </div>
                    <div className="flex flex-col items-center rounded-xl border border-primary/20 bg-white/80 backdrop-blur px-4 py-3 text-primary shadow-sm">
                      <span className="font-mono text-2xl font-bold leading-none">{pad2(hours)}</span>
                      <span className="mt-1 text-[11px] uppercase tracking-wide text-primary/70">Hours</span>
                    </div>
                    <div className="flex flex-col items-center rounded-xl border border-primary/20 bg-white/80 backdrop-blur px-4 py-3 text-primary shadow-sm">
                      <span className="font-mono text-2xl font-bold leading-none">{pad2(minutes)}</span>
                      <span className="mt-1 text-[11px] uppercase tracking-wide text-primary/70">Minutes</span>
                    </div>
                    <div className="flex flex-col items-center rounded-xl border border-primary/20 bg-white/80 backdrop-blur px-4 py-3 text-primary shadow-sm">
                      <span className="font-mono text-2xl font-bold leading-none">{pad2(seconds)}</span>
                      <span className="mt-1 text-[11px] uppercase tracking-wide text-primary/70">Seconds</span>
                    </div>
                  </div>
                </div>
              );
