  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 lg:pr-6">
        ...
        <Link
          className="px-3 sm:px-4 py-2 text-white bg-primary hover:shadow-lg hover:underline  border  hover:border-primary transition-all duration-300 rounded-lg font-medium text-lg"
          href="/market-place"
        >
          Browse Listed Properties
        </Link>

        <div className="mb-6 font-medium flex gap-2 items-center text-gray-800 dark:text-gray-200 mt-6">
