...
export default function PublicHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#05014c] text-white shadow-lg">
        ...
        <div className="flex items-center justify-between h-16">
            ...
            <div className="relative" onMouseLeave={() => setSitesOpen(false)}>
              <button
                ...
                className={cn(
                  ...
                  isSiteActive && "bg-white/15 text-orange-300"
                )}
              >
                  ...
                  {SITES.map((site) => (
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname === `/sites/${site.slug}` && "bg-blue-50"
                      )}
                    >
                      <MapPin className="w-4 h-4 text-[#05014c] mt-0.5 shrink-0" />
                      <div>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <SignedOut>
              ...
              <Link
                href="/sign-up"
                className="text-sm font-medium px-4 py-2 rounded-lg bg-orange-400 hover:bg-orange-500 text-white transition-colors"
              >
                Get Started
              </Link>
            </SignedOut>
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden bg-[#05014c] border-t border-white/10 px-4 pb-4 space-y-1">
          ...
          <div className="pt-2 flex gap-2">
            ...
            <SignedOut>
              ...
              <Link
                href="/sign-up"
                onClick={() => setMobileOpen(false)}
                className="flex-1 text-center text-sm font-medium px-4 py-2 rounded-lg bg-orange-400 hover:bg-orange-500 transition-colors"
              >
                Get Started
              </Link>
            </SignedOut>
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active && "bg-white/15 text-orange-300"
      )}
    >
      {children}
    </Link>
